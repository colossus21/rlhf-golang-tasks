...
func TestDockerAPIEnhancementsV2(t *testing.T) {
	var testCases = []struct {
		...
		{"TIME_DELAY is configurable", func(t *testing.T) {
			...
			delay := getEnvInt("TIME_DELAY", defaultTimeDelay)
			if delay != 5 {
				t.Errorf("Expected TIME_DELAY to be 5, got %d", delay)
			}
		}},
